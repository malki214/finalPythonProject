...
def histogram_functions_lengths():
...
def number_problems_for_each_problem_type():
    ...
    plt.savefig(f'./images/number_problems_for_each_problem_type.png')
    plt.close()
    # return f'{path}/images/number_problems_for_each_problem_type.png'


def number_problem_per_file():
    ...
    plt.savefig(f'./images/number_problem_per_file.png')
    plt.close()
...
if __name__=='__main__':
    ...
    Image.open("./images/histogram_functions_lengths.png").show()
    number_problems_for_each_problem_type()
    Image.open("./images/number_problems_for_each_problem_type.png").show()
    number_problem_per_file()
    Image.open("./images/number_problem_per_file.png").show()
